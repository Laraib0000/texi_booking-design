...
import 'package:qgo_application/Screens/User%20Side/UserMapPage.dart';
...
class ShareRidePage extends StatefulWidget {
  const ShareRidePage({Key? key}) : super(key: key);

  @override
  State<ShareRidePage> createState() => _ShareRidePageState();
}
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: SlidingUpPanel(
              ...
              maxHeight: 380,
              // header: Padding(
              //   padding: const EdgeInsets.fromLTRB(150, 10, 150, 5),
              //   child: Container(
              //     height: 2,
              //     width: 99,
              //     color: blackC,
                  ...
                  Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          children: [
                            ProfileContainer(image: 'assets/images/person.jpg'),
                            Text('Anisa'),
                          ],
                        ),
                        SizedBox(
                        ...
                        Column(
                          children: [
                            ProfileContainer(image: 'assets/images/user3.jpg'),
                            Text('Robert'),
                          ],
                        ),
                        SizedBox(
                        ...
                        Column(
                          children: [
                            ProfileContainer(image: 'assets/images/user4.jpg'),
                            Text('Ashley'),
                          ],
                        ),
                        SizedBox(
                        ...
                        Column(
                          children: [
                            ProfileContainer(image: 'assets/images/user5.jpg'),
                            Text('Karter'),
                          ],
                        ),
                      ],
